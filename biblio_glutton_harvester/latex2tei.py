...
class LaTeX2tei(object):
            ...
            for the_file in files:
                ...
                if the_file.endswith(".zip"):
                    ...
                    try:
                        ...
                        with zipfile.ZipFile(os.path.join(root,the_file), 'r') as zip_ref:
                        ...
                        status_result = "fail"
                        if the_file.endswith(".latex.zip"):
                            latex_tei_file = os.path.join(root, the_file.replace(".zip", ".tei.xml"))
                        else:
                            latex_tei_file = os.path.join(root, the_file.replace(".zip", ".latex.tei.xml"))
                        if len(latex_files) == 1:
                            ...
                            root_file = self.find_root_latex(latex_files)
                            if root_file != None:
                        ...
                        if status_result == "success":
                            ...
                            with self.env.begin() as txn:
                                ...
                                if local_object != None:
                                    ...
                                    if local_entry != None:
                                        local_entry["resources"]["latex"] = True
                                        update_entry = True
                                        if "resources" in local_entry and not "tei" in local_entry["resources"]:
                                            local_entry["resources"]["tei"] = True
                        ...
                        if not the_file.endswith(".latex.zip"):
                            os.rename(os.path.join(root,the_file), os.path.join(root,the_file.replace(".zip", ".latex.zip")))
    ...
    def find_root_latex(self, latex_file_lists):
